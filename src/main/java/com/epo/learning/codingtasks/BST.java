...
public class BST {
    ...
    private static boolean isBstHelper(TreeNode head, Integer lowerLim, Integer upperLim) {

        if(lowerLim != null && head.value < lowerLim) {
            return false;
        }
        if (upperLim != null && head.value > upperLim) {
            return false;
        }
        ...
        if (head.left != null) {
            isLeftBST = isBstHelper(head.left, lowerLim, head.value);
        }
        if (head.right != null) {
            isRightBst = isBstHelper(head.right, head.value, upperLim);
        }
